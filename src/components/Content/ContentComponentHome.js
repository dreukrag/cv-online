        ...
        (
            <div>
                ...
                <div className="parallax parallax__blur-home large-window" >
                    <div className="content-component__caption-brand" style={{ paddingTop:"70px",paddingLeft:"25px"}}>
                    ...
                    <div className="content-component__caption-main">
                        ...
                        <p>Quanto aos básicos, domino HTML5, CSS 3.0, Node.js, Firebase e Git . Para javascript uso o padrão es6. Também possuo experiência em C#, VBA e SQL e sou familiar com Java, php, python. Apesar de apenas um hobby eu também domino SketchUp e sou familiar com Blender.</p>
